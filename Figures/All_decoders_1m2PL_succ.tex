...
%		xmode=log,
       ...
       % legend entries={{\hspace{-2em}$\Delta\in[.1\sqrt{2}, .7\sqrt{2}]$}, data, fit},
		...
		\addlegendentry{forward 0 decoder}
...
%			
		...
		\foreach \F in {300,400}{
			...
			table [x expr={\thisrow{M}+1}, y expr={1-2*\thisrow{P_MLD}}, y error expr={sqrt(2)*\thisrow{s_P_MLD}}]{\sortedtable};}
		...
		\foreach \F in {300,400}{
			...
			table [x expr={\thisrow{M}+1}, y expr={1-2*\thisrow{P_0}}, y error expr={sqrt(2)*\thisrow{s_P_0}}]{\sortedtable};}
		...
		\foreach \F in {300,400}{
			...
			table [x expr={\thisrow{M}+1}, y expr={1-2*\thisrow{P_Forward}}, y error expr={sqrt(2)*\thisrow{s_P_Forward}}]{\sortedtable};}
		...
		\foreach \F in {300,400}{
			...
			table [x expr={\thisrow{M}+1}, y expr={1-2*\thisrow{P_Forward_sample}}, y error expr={sqrt(2)*\thisrow{s_P_Forward_sample}}]{\sortedtable};}
