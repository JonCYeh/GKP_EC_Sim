...
%			
		\foreach \F in {300,350,400,450}{
			\pgfplotstablesort{\sortedtablemld}{../results_new/MLD_D\F.txt}
			\addplot[
			color=color1,
			%only marks,
			mark=diamond,
			...
			table [x expr={\thisrow{n_steps}}, y expr={\thisrow{logical_error_rate}}, y error expr={\thisrow{std}}]{\sortedtablemld};}
			
		\foreach \F in {300,350,400,450}{
			\pgfplotstablesort{\sortedtablezeno}{../results_new/0_D\F.txt}
			\addplot[
			color=color6,
			%only marks,
			mark=otimes,
		...
		\foreach \F in {300,350,400,450}{
			\pgfplotstablesort{\sortedtable}{../results_new/Forwardcoh_D\F.txt}
			\addplot[
			color=color2,
			%only marks,
			mark=square,
